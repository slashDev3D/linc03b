        ...
        <div class="mainBannerSwiper">
            <div class="swiper-wrapper">
                <!-- 해당 콘텐츠 개수 만큼 이 슬라이드를 복제해주세요 -->
                    ...
                    <div class="swiper-slide" style="background-color:#0057e4">
                    ...
                    <div class="swiper-slide" style="background-color:#0e111a">
                        <div class="swiper-slide-img-bg" >
                            <!--이벤트 컨텐츠 중 이미지01 = background-image:url(이곳으로 들어가게 해주세요)-->
                    ...
                    <div class="swiper-slide" style="background-color:#e84936">
                        <div class="swiper-slide-img-bg" >
                            <!--이벤트 컨텐츠 중 이미지01 = background-image:url(이곳으로 들어가게 해주세요)-->
